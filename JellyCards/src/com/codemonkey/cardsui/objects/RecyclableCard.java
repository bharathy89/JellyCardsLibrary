...
public abstract class RecyclableCard extends Card {
    ...
    public RecyclableCard(Context context) {
        super();
    }

    public RecyclableCard(Context context, String title, int image) {
        super(title, image);
    }

    public RecyclableCard(Context context, String titlePlay, String description, int imageRes,
                          String titleColor, Boolean hasOverflow, Boolean isClickable) {
        super(titlePlay, description, imageRes, titleColor, hasOverflow, isClickable);
    }

    public RecyclableCard(Context context, String title, String desc, int image) {
        super( title, desc, image);
    }

    public RecyclableCard(Context context,String titlePlay, String description, String color,
                          String titleColor, Boolean hasOverflow, Boolean isClickable) {
        super(titlePlay, description, color, titleColor, hasOverflow, isClickable);
    }

    public RecyclableCard(Context context,String title, String desc) {
        super(title, desc);
    }

    public RecyclableCard(Context context,String title) {
        super(title);
    }
